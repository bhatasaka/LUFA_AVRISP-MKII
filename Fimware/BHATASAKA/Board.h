...
/** \file
 *  \brief Board specific information header for the custom PCB made by Bryan Hatasaka.
 *  \copydetails Group_BoardInfo_BHATASAKA
 *
 ...
 *  \defgroup Group_BoardInfo_BHATASAKA BHATASAKA
 *  \brief Board specific information header for the custom PCB made by Bryan Hatasaka.
 *
 *  Board specific information header for my board
 *
 *  @{
 */

#ifndef __BOARD_BHATASAKA_H__
#define __BOARD_BHATASAKA_H__
